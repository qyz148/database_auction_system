...
<div class="container">
  ...
  <?php // This page is for showing a user the auction listings they've made. // It will be pretty similar to browse.php, except there is no search bar. // This can be started after browse.php is working with a database. // Feel free to extract out useful functions from browse.php and put them in // the shared "utilities.php" where they can be shared by multiple files.
    ...
    $user_id = $_SESSION["user_id"]; // Get the logged-in user's ID. // Pagination setup.
    $results_per_page = 10; // Number of results per page.
    $curr_page = isset($_GET["page"]) ? $_GET["page"] : 1; // Current page.
    $offset = ($curr_page - 1) * $results_per_page; // TODO: Perform a query to pull up their auctions.
  ...
  <!-- Pagination for results listings -->
    <nav aria-label="Search results pages" class="mt-5" id="paginationBar" style=<?php if($total>0){echo"";}else{echo"display:none";};?> >
      ...
      // Copy any currently-set GET variables to the URL.
        ...
        if ($curr_page != 1) {
          echo '
            <li class="page-item">
              <a class="page-link" href="mylistings.php?' .
              $querystring .
              "page=" .
              ($curr_page - 1) .
              '" aria-label="Previous">
        ...
        for ($i = $low_page; $i <= $high_page; $i++) {
          ...
          echo '<a class="page-link" href="mylistings.php?' .
              $querystring .
              "page=" .
              $i .
              '">' .
